...
class MarkerServiceTest {
    ...
    void createMarker_Success() {
        ...
        MarkerDto result = markerService.createMarker(userId, dto);
...
@Test
    ...
    void moveMarker_MoveDown() {
        ...
        markerService.moveMarker(userId, markerId, newOrder);
    ...
    void getMarkers_Success() {
        ...
        List<MarkerDto> results = markerService.GetMarkers(userId);
    ...
    void getMarkers_UserNotFound() {
        Long noMarkerUserId = 999L; // DB에 마커가 없는 임의의 ID

        // When
        List<MarkerDto> result = markerService.GetMarkers(noMarkerUserId);
